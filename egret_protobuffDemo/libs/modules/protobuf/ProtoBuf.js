...
(function (s) {
    function u(k) {
        function g(a, b, c) { "undefined" === typeof a && (a = g.DEFAULT_CAPACITY); "undefined" === typeof b && (b = g.DEFAULT_ENDIAN); "undefined" === typeof c && (c = g.DEFAULT_NOASSERT); if (!c) {
            ...
            b = !!b;
            c = !!c;
        } this.buffer = 0 === a ? s : new ArrayBuffer(a); this.view = 0 === a ? null : new DataView(this.buffer); this.offset = 0; this.markedOffset = -1; this.limit = a; this.littleEndian = "undefined" !== typeof b ? !!b : !1; this.noAssert = !!c; }
        function m(a) {
            var b = 0;
            return function () {
                return b <
        ...
        function t() { var a = [], b = []; return function () { if (0 === arguments.length)
            return b.join("") + u.apply(String, a); 1024 < a.length + arguments.length && (b.push(u.apply(String, a)), a.length = 0); Array.prototype.push.apply(a, arguments); }; }
        g.VERSION = "3.5.4";
        g.LITTLE_ENDIAN = !0;
        g.BIG_ENDIAN = !1;
        ...
        g.concat = function (a, b, c, d) { if ("boolean" === typeof b || "string" !== typeof b)
            d = c, c = b, b = void 0; for (var f = 0, n = 0, h = a.length, e; n < h; ++n)
            g.isByteBuffer(a[n]) || (a[n] = g.wrap(a[n], b)), e = a[n].limit - a[n].offset, 0 < e && (f += e); if (0 === f)
            return new g(0, c, d); b = new g(f, c, d); d = new Uint8Array(b.buffer); for (n = 0; n < h;)
            c = a[n++], e = c.limit - c.offset, 0 >= e || (d.set((new Uint8Array(c.buffer)).subarray(c.offset, c.limit), b.offset), b.offset += e); b.limit = b.offset; b.offset = 0; return b; };
        ...
        e.readInt8 = function (a) { var b = "undefined" === typeof a; b && (a = this.offset); if (!this.noAssert) {
            if ("number" !== typeof a || 0 !== a % 1)
                throw TypeError("Illegal offset: " + a + " (not an integer)");
            a >>>= 0;
            if (0 > a || a + 1 > this.buffer.byteLength)
                throw RangeError("Illegal offset: 0 <= " + a + " (+1) <= " + this.buffer.byteLength);
        } a = this.view.getInt8(a); b && (this.offset += 1); return a; };
        ...
        e.readUint8 =
            function (a) { var b = "undefined" === typeof a; b && (a = this.offset); if (!this.noAssert) {
                if ("number" !== typeof a || 0 !== a % 1)
                    throw TypeError("Illegal offset: " + a + " (not an integer)");
                a >>>= 0;
                if (0 > a || a + 1 > this.buffer.byteLength)
                    throw RangeError("Illegal offset: 0 <= " + a + " (+1) <= " + this.buffer.byteLength);
            } a = this.view.getUint8(a); b && (this.offset += 1); return a; };
        ...
        g.calculateVarint32 = function (a) { a >>>= 0; return 128 > a ? 1 : 16384 > a ? 2 : 2097152 > a ? 3 : 268435456 > a ? 4 : 5; };
        ...
        e.readVarint32ZigZag = function (a) { a = this.readVarint32(a); "object" === typeof a ? a.value = g.zigZagDecode32(a.value) : a = g.zigZagDecode32(a); return a; };
        k && (g.MAX_VARINT64_BYTES = 10, g.calculateVarint64 = function (a) { "number" === typeof a && (a = k.fromNumber(a)); var b = a.toInt() >>> 0, c = a.shiftRightUnsigned(28).toInt() >>> 0; a = a.shiftRightUnsigned(56).toInt() >>> 0; return 0 == a ? 0 == c ? 16384 > b ? 128 > b ? 1 : 2 : 2097152 > b ? 3 : 4 : 16384 > c ? 128 > c ? 5 : 6 : 2097152 > c ? 7 : 8 : 128 > a ? 9 : 10; }, g.zigZagEncode64 = function (a) {
            "number" === typeof a ?
            ...
            b -= d;
            switch (d) {
                case 10: this.view.setUint8(b + 9, e >>> 7 & 1);
                case 9: this.view.setUint8(b + 8, 9 !== d ? e | 128 : e & 127);
                case 8: this.view.setUint8(b + 7, 8 !== d ? n >>> 21 | 128 : n >>> 21 & 127);
                case 7: this.view.setUint8(b + 6, 7 !== d ? n >>> 14 | 128 : n >>> 14 & 127);
                case 6: this.view.setUint8(b + 5, 6 !== d ? n >>> 7 | 128 : n >>> 7 & 127);
                case 5: this.view.setUint8(b + 4, 5 !== d ? n | 128 : n & 127);
                case 4: this.view.setUint8(b + 3, 4 !== d ? f >>> 21 | 128 : f >>> 21 & 127);
                case 3: this.view.setUint8(b + 2, 3 !== d ? f >>> 14 | 128 : f >>> 14 & 127);
                case 2: this.view.setUint8(b + 1, 2 !== d ? f >>> 7 | 128 : f >>> 7 &
                    127);
                case 1: this.view.setUint8(b, 1 !== d ? f | 128 : f & 127);
            }
            return c ? (this.offset += d, this) : d;
        ...
        }, e.readVarint64ZigZag = function (a) { (a = this.readVarint64(a)) && a.value instanceof k ? a.value = g.zigZagDecode64(a.value) : a = g.zigZagDecode64(a); return a; });
        e.writeCString = function (a, b) {
            ...
            b -= f + 1;
            l.c(m(a), function (a) { this.view.setUint8(b++, a); }.bind(this));
        ...
        e.readCString = function (a) {
            ...
            var c = a, d, f = -1;
            l.b(function () { if (0 === f)
                return null; if (a >= this.limit)
                throw RangeError("Illegal range: Truncated data, " + a + " < " + this.limit); return 0 === (f = this.view.getUint8(a++)) ? null : f; }.bind(this), d = t(), !0);
        ...
        e.readIString = function (a) {
            ...
            a += 4;
            var f = a + c;
            l.b(function () { return a < f ? this.view.getUint8(a++) : null; }.bind(this), c = t(), this.noAssert);
            c = c();
        ...
        e.readUTF8String = function (a, b, c) {
            ...
            if (b === g.METRICS_CHARS) {
                h = t();
                l.g(function () { return f < a && c < this.limit ? this.view.getUint8(c++) : null; }.bind(this), function (a) { ++f; l.e(a, h); }.bind(this));
                if (f !== a)
            ...
            if (b === g.METRICS_BYTES) {
                ...
                var r = c + a;
                l.b(function () { return c < r ? this.view.getUint8(c++) : null; }.bind(this), h = t(), this.noAssert);
                if (c !== r)
        ...
        e.readVString = function (a) {
            ...
            l.b(function () { return a < f ? this.view.getUint8(a++) : null; }.bind(this), c, this.noAssert);
            c = c();
            return b ? (this.offset = a, c) : { string: c, length: a - d };
        };
        ...
        e.assert = function (a) { this.noAssert = !a; return this; };
        e.capacity = function () { return this.buffer.byteLength; };
        e.clear = function () { this.offset = 0; this.limit = this.buffer.byteLength; this.markedOffset = -1; return this; };
        e.clone = function (a) {
        ...
        e.ensureCapacity = function (a) { var b = this.buffer.byteLength; return b < a ? this.resize((b *= 2) > a ? b : a) : this; };
        ...
        e.flip = function () { this.limit = this.offset; this.offset = 0; return this; };
        e.mark = function (a) {
        ...
        e.order = function (a) { if (!this.noAssert && "boolean" !== typeof a)
            throw TypeError("Illegal littleEndian: Not a boolean"); this.littleEndian = !!a; return this; };
        e.LE = function (a) { this.littleEndian = "undefined" !== typeof a ? !!a : !0; return this; };
        e.BE = function (a) { this.littleEndian = "undefined" !== typeof a ? !a : !1; return this; };
        ...
        e.prependTo = function (a, b) { a.prepend(this, b); return this; };
        e.printDebug = function (a) {
            "function" !== typeof a && (a = console.log.bind(console));
            a(this.toString() + "\n-------------------------------------------------------------------\n" +
                this.toDebug(!0));
        };
        e.remaining = function () { return this.limit - this.offset; };
        e.reset = function () { 0 <= this.markedOffset ? (this.offset = this.markedOffset, this.markedOffset = -1) : this.offset = 0; return this; };
        e.resize = function (a) {
            if (!this.noAssert) {
                if ("number" !== typeof a || 0 !== a % 1)
        ...
        e.skip = function (a) { if (!this.noAssert) {
            if ("number" !== typeof a || 0 !== a % 1)
                throw TypeError("Illegal length: " + a + " (not an integer)");
            a |= 0;
        } var b = this.offset + a; if (!this.noAssert && (0 > b || b > this.buffer.byteLength))
            throw RangeError("Illegal length: 0 <= " + this.offset + " + " + a + " <= " + this.buffer.byteLength); this.offset = b; return this; };
        ...
        var v = function () {
            for (var a = {}, b = [65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82,
                ...
                c[b[d]] = d;
            a.i = function (a, c) { for (var d, f; null !== (d = a());)
            ...
            a.h = function (a, b) {
                function d(a) { throw Error("Illegal character code: " + a); }
        ...
        e.toBase64 = function (a, b) {
            ...
            var c;
            v.i(function () { return a < b ? this.view.getUint8(a++) : null; }.bind(this), c = t());
            return c();
        };
        g.fromBase64 = function (a, b, c) {
            ...
            v.h(m(a), function (a) { d.view.setUint8(f++, a); });
            d.limit = f;
            return d;
        };
        ...
        var l = function () {
            var a = { k: 1114111, j: function (a, c) {
                    ...
                    65535 >= d ? c(d) : (d -= 65536, c((d >> 10) + 55296), c(d % 1024 + 56320)), d = null; }, c: function (b, c) { a.d(b, function (b) { a.j(b, c); }); }, b: function (b, c) { a.g(b, function (b) { a.e(b, c); }); }, f: function (a) { return 128 > a ? 1 : 2048 > a ? 2 : 65536 > a ? 3 : 4; }, l: function (b) { for (var c, d = 0; null !== (c = b());)
                    d += a.f(c); return d; }, a: function (b) { var c = 0, d = 0; a.d(b, function (b) { ++c; d += a.f(b); }); return [c, d]; } };
            return a;
        }();
        e.toUTF8 = function (a, b) {
            ...
            var c;
            try {
                l.b(function () { return a < b ? this.view.getUint8(a++) : null; }.bind(this), c = t());
            }
            catch (d) {
                if (a !== b)
        ...
        g.fromUTF8 = function (a, b, c) { if (!c && "string" !== typeof a)
            throw TypeError("Illegal str: Not a string"); var d = new g(l.a(m(a), !0)[1], b, c), e = 0; l.c(m(a), function (a) { d.view.setUint8(e++, a); }); d.limit = e; return d; };
        return g;
    }
    "function" === typeof require && "object" === typeof module && module && "object" === typeof exports && exports ? module.exports = function () { var k; try {
        k = require("long");
    }
    catch (g) { } return u(k); }() : "function" === typeof define && define.amd ? define("ByteBuffer", ["Long"], function (k) { return u(k); }) : (s.dcodeIO = s.dcodeIO || {}).ByteBuffer = u(s.dcodeIO.Long);
})(this);
(function () {
    (function (q) {
        ...
        b.prototype.greaterThanOrEqual = function (a) { return 0 <= this.compare(a); };
        ...
        b.prototype.subtract =
            function (a) { b.isLong(a) || (a = b.fromValue(a)); return this.add(a.negate()); };
        ...
        "function" === typeof require && "object" === typeof module && module && "object" === typeof exports && exports ? module.exports = b : "function" === typeof define &&
            define.amd ? define(function () { return b; }) : (q.dcodeIO = q.dcodeIO || {}).Long = b;
    })(this);
})();
/*
